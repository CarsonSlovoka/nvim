...
local function startup_time(start_time)
  ...
  return "Neovim startup time: " .. time_ms .. " ms"
end
...
function M.setup(opts)
  ...
  local content = {
    ...
    { text = "  ,bk   [open bookmark]",                        highlight = "StartupMenu", highlight_range = { 2, 5 } },
    { text = "  ,t    [nvimTree open]",                        highlight = "StartupMenu", highlight_range = { 2, 4 } },
    { text = "  ,cd   [change dir]",                           highlight = "StartupMenu", highlight_range = { 2, 5 } },
    { text = "",                                               highlight = nil }, -- 空行
